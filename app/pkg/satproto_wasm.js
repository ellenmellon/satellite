/* @ts-self-types="./satproto_wasm.d.ts" */
 ...
 */
export function bootstrap(domain) {
    const ptr0 = passStringToWasm0(domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.bootstrap(ptr0, len0);
    return ret;
}

/**
 * Create a new post. Returns the new post as JSON.
 * @param {string} author_domain
 * @param {string} text
 * @param {string | null} [reply_to]
 * @param {string | null} [reply_to_author]
 * @param {string | null} [repost_of]
 * @param {string | null} [repost_of_author]
 * @returns {Promise<any>}
 */
export function create_post(author_domain, text, reply_to, reply_to_author, repost_of, repost_of_author) {
    const ptr0 = passStringToWasm0(author_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    var ptr3 = isLikeNone(reply_to_author) ? 0 : passStringToWasm0(reply_to_author, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(repost_of) ? 0 : passStringToWasm0(repost_of, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len4 = WASM_VECTOR_LEN;
    var ptr5 = isLikeNone(repost_of_author) ? 0 : passStringToWasm0(repost_of_author, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len5 = WASM_VECTOR_LEN;
    const ret = wasm.create_post(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
    return ret;
}

/**
 * Follow a user. Encrypts our content key for them and updates follows list.
 * @param {string} my_domain
 * @param {string} target_domain
 * @returns {Promise<void>}
 */
export function follow_user(my_domain, target_domain) {
    const ptr0 = passStringToWasm0(my_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(target_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.follow_user(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function get_follows(my_domain) {
    const ptr0 = passStringToWasm0(my_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_follows(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function load_feed(my_domain) {
    const ptr0 = passStringToWasm0(my_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_feed(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function load_replies(my_domain, post_id, post_author) {
    const ptr0 = passStringToWasm0(my_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(post_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(post_author, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.load_replies(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
 ...
 * @returns {Promise<void>}
 */
export function unfollow_user(my_domain, target_domain) {
    const ptr0 = passStringToWasm0(my_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(target_domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.unfollow_user(ptr0, len0, ptr1, len1);
    return ret;
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h4fbb9ff7f0d78d7e, wasm_bindgen__convert__closures_____invoke__h8912b03767920e75);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./satproto_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h8912b03767920e75(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h8912b03767920e75(arg0, arg1, arg2);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('satproto_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
